 ...
 */
CKEDITOR.plugins.add("wpmore",{requires:["fakeobjects"],getPlaceholderCss:function(){return"img.cke_wordpress_more{background-image: url("+CKEDITOR.getUrl(this.path+"images/more_bug.gif")+");background-position: right center;background-repeat: no-repeat;clear: both;display: block;float: none;width: 100%;border-top: #999999 1px dotted;height: 10px;}"},onLoad:function(){CKEDITOR.addCss&&CKEDITOR.addCss(this.getPlaceholderCss())},init:function(e){function t(t){CKEDITOR.dom.comment.prototype.getAttribute||(CKEDITOR.dom.comment.prototype.getAttribute=function(){return""},CKEDITOR.dom.comment.prototype.attributes={align:""});for(var o,r=e.createFakeElement(new CKEDITOR.dom.comment(t),"cke_wordpress_"+t,"hr"),n=e.getSelection().getRanges()[0],a=new CKEDITOR.dom.elementPath(n.getCommonAncestor(!0)),m=a.block&&a.block.getParent()||a.blockLimit;m&&"body"!=m.getName();)n.moveToPosition(m,CKEDITOR.POSITION_AFTER_END),o=1,m=m.getParent();n.insertNode(r);for(var i=r;(i=i.getNext())&&!n.moveToElementEditStart(i););n.select()}e.addCss&&e.addCss(this.getPlaceholderCss()),e.ui.addButton("WPMore",{label:"Insert More Break",icon:this.path+"images/more.gif",command:"wpmore"}),e.addCommand("wpmore",{exec:function(){for(var o=e.document.getElementsByTag("img"),r=0,n=o.count();n>r;r++){var a=o.getItem(r);if(a.hasClass("cke_wordpress_more")){var m="The document already contains a more. Do you want to proceed by removing it first?";if(confirm(m)){a.remove();break}return}}t("more")}})},afterInit:function(e){e.dataProcessor.dataFilter.addRules({comment:function(t){return CKEDITOR.htmlParser.comment.prototype.getAttribute||(CKEDITOR.htmlParser.comment.prototype.getAttribute=function(){return""},CKEDITOR.htmlParser.comment.prototype.attributes={align:""}),"more"==t?e.createFakeParserElement(new CKEDITOR.htmlParser.comment(t),"cke_wordpress_"+t,"hr"):t}})}});